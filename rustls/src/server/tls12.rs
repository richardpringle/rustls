...
mod client_hello {
    ...
    use crate::msgs::handshake::{
        CertificateChain, CertificateRequestPayload, CertificateStatus, ClientExtension,
        ClientHelloPayload, ClientSessionTicket, EcdheServerKeyExchange, Random, ServerEcdhParams,
